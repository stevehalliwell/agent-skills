// Vendored from yaml v2.9.0 (MIT); see ../references/third-party-notices.md.
...
var require_identity = __commonJS({
  "node_modules/yaml/dist/nodes/identity.js"(exports) {
    ...
    var isScalar4 = (node) => !!node && typeof node === "object" && node[NODE_TYPE] === SCALAR;
    ...
    var hasAnchor = (node) => (isScalar4(node) || isCollection(node)) && !!node.anchor;
    exports.ALIAS = ALIAS;
    exports.DOC = DOC;
    exports.MAP = MAP;
...
var require_Scalar = __commonJS({
  "node_modules/yaml/dist/nodes/Scalar.js"(exports) {
    ...
    var Node = require_Node();
    var toJS = require_toJS();
    var isScalarValue2 = (value2) => !value2 || typeof value2 !== "function" && typeof value2 !== "object";
    ...
    exports.Scalar = Scalar;
    exports.isScalarValue = isScalarValue2;
  }
});
...
var yaml_exports = require_dist();
export const parseDocument = yaml_exports.parseDocument;
export const stringify = yaml_exports.stringify;
export const isMap = yaml_exports.isMap;
export const isScalar = yaml_exports.isScalar;
export const isSeq = yaml_exports.isSeq;
