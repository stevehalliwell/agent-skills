...
5. Handle tooling and guidance. If profiler/benchmark tooling is absent, propose smallest setup and wait before installation or project changes. Verify uncertain Three.js/browser guidance with authoritative sources. Done when evidence is captured or deferred.
